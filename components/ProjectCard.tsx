...
export default function ProjectCard({
  ...
  return (
    <div className="group p-5 -mx-5 rounded-lg transition-colors duration-200 hover:bg-stone-100 dark:hover:bg-stone-900/50">
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="flex items-center gap-3 text-stone-400 dark:text-stone-500">
          <a
            ...
            className="transition-colors duration-200 hover:text-stone-700 dark:hover:text-stone-300"
